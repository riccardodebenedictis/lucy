...
namespace lucy {
	...
	item* expr::operator->() const { return static_cast<item*>(ptr); }
	expr::operator expr() const { return expr(static_cast<item*>(ptr)); }
	...
	bool_item* bool_expr::operator->() const { return static_cast<bool_item*>(ptr); }
	bool_expr::operator bool_expr() const { return bool_expr(static_cast<bool_item*>(ptr)); }
	...
	arith_item* arith_expr::operator->() const { return static_cast<arith_item*>(ptr); }
	arith_expr::operator arith_expr() const { return arith_expr(static_cast<arith_item*>(ptr)); }
	...
	string_item* string_expr::operator->() const { return static_cast<string_item*>(ptr); }
	string_expr::operator string_expr() const { return string_expr(static_cast<string_item*>(ptr)); }
	...
	enum_item* enum_expr::operator->() const { return static_cast<enum_item*>(ptr); }
	enum_expr::operator enum_expr() const { return enum_expr(static_cast<enum_item*>(ptr)); }
}