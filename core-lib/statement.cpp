...
assignment_statement::assignment_statement(const std::vector<std::string> &q_id, expression *const e) : qualified_id(q_id), xpr(e) {}
assignment_statement::~assignment_statement() {}

local_field_statement::local_field_statement(const std::vector<std::string> &ft, const std::string &n, expression *const e) : field_type(ft), name(n), xpr(e) {}
local_field_statement::~local_field_statement() {}

expression_statement::expression_statement(bool_expression *const e) : xpr(e) {}
...
return_statement::return_statement(expression *const e) : xpr(e) {}
